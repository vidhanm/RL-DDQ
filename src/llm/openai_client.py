...
class OpenAIClient:
    """Wrapper for OpenAI API with retry logic and specific methods for our use case"""
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.model = LLMConfig.MODEL_NAME if not LLMConfig.USE_DEV_MODEL else LLMConfig.MODEL_NAME_DEV
    ...
    def print_statistics(self):
        ...
        if "gpt-4" in stats['model']:
            cost_prompt = stats['total_tokens_prompt'] / 1000 * 0.01
            cost_completion = stats['total_tokens_completion'] / 1000 * 0.03
        else:  # GPT-3.5
            cost_prompt = stats['total_tokens_prompt'] / 1000 * 0.0005
            cost_completion = stats['total_tokens_completion'] / 1000 * 0.0015
